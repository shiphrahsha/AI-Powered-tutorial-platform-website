        ...
        <section className="testimonials" id="testimonials">
          ...
          <div className="testimonials-container">
            <div className="testimonial-item">
              ...
              <p>"This platform has transformed my learning experience. The personalized lessons are amazing!"</p>
              <h4>- Student Name</h4>
            </div>
            <div className="testimonial-item">
              <img src={parentTestimonial} alt="Parent Testimonial" />
              <p>"My child's grades have improved significantly since using this tutoring platform."</p>
              <h4>- Parent Name</h4>
            </div>
            <div className="testimonial-item">
              <img src={tutorTestimonial} alt="Tutor Testimonial" />
              <p>"As a tutor, I find this platform incredibly helpful for providing tailored assistance to students."</p>
              <h4>- Tutor Name</h4>
            </div>
          </div>
        </section>
        ...
        <section className="courses" id="courses">
          ...
          <div className="courses-container">
            <div className="course-item">
              <h3>Math</h3>
              <p>Comprehensive math lessons from basic arithmetic to advanced calculus.</p>
            </div>
            <div className="course-item">
              <h3>Science</h3>
              <p>Explore physics, chemistry, biology, and more with interactive lessons.</p>
            </div>
            <div className="course-item">
              <h3>Languages</h3>
              <p>Learn new languages with tailored lessons and practice exercises.</p>
            </div>
            <div className="course-item">
              <h3>Test Prep</h3>
        ...
        <section className="faq" id="faq">
          ...
          <div className="faq-container">
            <div className="faq-item">
              ...
              <p>Our platform uses AI to provide personalized learning experiences for students of all ages.</p>
            </div>
            <div className="faq-item">
              <h3>How does the platform personalize learning?</h3>
              <p>We use an initial assessment to understand each student's needs and tailor lessons accordingly.</p>
            </div>
            <div className="faq-item">
              <h3>What subjects are available?</h3>
              <p>We offer a wide range of subjects including Math, Science, Languages, and Test Prep.</p>
            </div>
            <div className="faq-item">
